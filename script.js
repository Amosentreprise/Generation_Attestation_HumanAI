...
function telecharge(){
    ...
    var certificat = document.getElementById('attestation');
     ...
     var opt = {
                margin: 10,
                filename: `Attestation_Ambassadeur${Date.now()}.pdf`,
                image: { type: 'jpeg', quality: 0.98 },
                html2canvas: { scale: 2 },
                jsPDF: { unit: 'mm', format: 'a4', orientation: 'landscape' } // Définir l'orientation sur 'landscape' pour le mode paysage
            };
    ...
    function afficherPDF(){
        ...
        localStorage.setItem("key", `${form_prenom.toUpperCase()} ${form_nom.toUpperCase()}`)
        ...
        if(form_nom && form_prenom && form_date){
            ...
            <div class="w-full h-screen flex  flex-col justify-center  bg-white " >
                ...
                <div class=" w-full  absolute top-4">
                    <div class="entete flex justify-evenly items-center">
                        <img src="./assets/logo.png" alt="" class="w-20 h-20 object-cover mt-6">
                        <h1 class="text-4xl font-bold font-cinzel mt-6 tracking-wider">ATTESTATION <br class="mt-4"> <span class="text-2xl">D'AMBASSADEUR</span></h1>
                        <img src="./assets/logo.png" alt="" class="w-20 h-20 object-cover mt-5">
                    </div>
                    
                
                    <div class="contenu flex flex-col justify-center items-center  ">
                        <p class="text-xl mt-4">Décerné à :</p>
                        <h2 class="text-2xl font-bold mt-5 font-glacial">${form_prenom.toUpperCase()}  ${form_nom.toUpperCase()}</h2>
                        <hr class="h-8 w-[200px] border-slate-600 mt-2">
                        <p class="text-xl">Est Ambassadeur de <span class="text-human font-bold">Human AI</span></p>
                        <p class="text-xl">Depuis le <span>${form_date}</span></p>
                    </div>
        
        
                    <div class=" flex justify-center mt-3">
                        <img src="./assets/bagde.png" alt="" class="w-32 h-32 object-cover">
                        
                        
                    </div>
                    <div class="relative -top-36">
                        <img src="./assets/Cachet_Human_AI.png" alt="" class=" relative w-32 h-32 float-end mr-40 object-cover">
                        
                     </div>
                     <img src="./assets/Signature_Human_AI.png" alt="" class="relative float-right  -right-48 -top-32 w-60 h-60  ">
